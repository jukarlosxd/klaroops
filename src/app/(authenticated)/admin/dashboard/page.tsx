...
export default async function AdminDashboardPage(props: { searchParams: Promise<any> }) {
  ...
  try {
    ...
    // Ensure stats objects are safe
    const safeStats = {
      totalAmbassadors: stats?.totalAmbassadors || 0,
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <h3 className="text-3xl font-bold mt-1 text-gray-900">{safeStats.totalAmbassadors}</h3>
              </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <h3 className="text-3xl font-bold mt-1 text-gray-900">{safeStats.totalClients}</h3>
              </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <h3 className="text-3xl font-bold mt-1 text-gray-900">{safeStats.leadsThisMonth}</h3>
              </div>
            ...
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <h3 className="text-3xl font-bold mt-1 text-red-600">
                  ${safeStats.pendingCommissions.toLocaleString('en-US', { minimumFractionDigits: 2 })}
                </h3>
              </div>
